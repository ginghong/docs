...
| Market | User reserve | Internal reserve | Decimals | Buy behavior |
| --- | --- | --- | --- | --- |
| `EthTopicMarketV3` | ETH | Canonical WETH | 18 | Wraps the quote and refunds excess ETH |
| `UsdcTopicMarketV3` | mUSDC | `MockUSDC` | 6 | Transfers a maximum payment and refunds unused mUSDC |
